...
const FUTUROS_INFO = "Contratos futuros são operações sofisticadas feitas pela modalidade de derivativos. Nessas operações, um investidor se compromete a comprar ou a vender determinado ativo em uma data futura pré-estabelecida. São contratos com prazo determinado de vencimento e que necessitam de alocação de margem para  garantias.";
const FUNDOS_INFO = "Fundos são uma espécie de “condomínio” de investidores. Eles reúnem os recursos de diversas pessoas, para que sejam aplicados em conjunto no mercado financeiro e de capitais. Os ganhos obtidos com as aplicações são divididos entre os participantes, na proporção do valor depositado por cada um. Esses fundos podem ser estruturados por ativos de Títulos de Renda Fixa, Títulos Públicos, Títulos Cambiais, Derivativos, Commodities, Ações, entre outros. Quanto mais diversificado é o fundo, menor é o risco.";
